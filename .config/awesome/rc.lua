...
globalkeys = gears.table.join(
    ...
    awful.key({}, "#107", function () awful.util.spawn_with_shell("scrot 'Full_Screenshot_%Y-%m-%d_at_%H-%M-%S.png' -e 'mv $f ~/Pictures/Screenshots/'") end,
                {description = "Screenshot of Entire Screen", group = "launcher"}),
    awful.key({ }, "#123", function () awful.util.spawn("amixer set 'Master' 10%+") end,
            {description = "Increase Volume", group = "Controls"}),
    awful.key({ }, "#122", function () awful.util.spawn("amixer set 'Master' 10%-") end,
            {description = "Increase Volume", group = "Controls"}),
    awful.key({ }, "#198", function () awful.util.spawn("amixer set 'Master' 0%") end,
            {description = "Mute Volume", group = "Controls"}),
    awful.key({ }, "#121", function () awful.util.spawn("amixer set 'Master' 0%") end,
            {description = "Mute Volume", group = "Controls"}),
...
awful.rules.rules = {
    ...
    -- { rule = { class = "Kronometer" },
	-- properties = { screen = 1, tag = "1" } },
    -- { rule = { class = "spotify" },
	-- properties = { screen = 2, tag = "6" } },
    -- { rule = { class = "gnome-system-manager" },
	-- properties = { screen = 2, tag = "6" } },
    -- { rule = { class = "pcmanfm" },
...
-- if you want to make everything rounded. 
